...
class MultiImageSelectFrame:
    def __init__(self, parent, event_dispatcher: EventDispatcher, show_pattern_upload=True):
        self.frame = ttk.Frame(parent)
        self.event_dispatcher = event_dispatcher
        ...
        # Create read-only pattern display
        ...
        uv_focus_predefined = [
            ("Plus Mark", "src/uvFocusImage/plus.png"),
            ("Snake Mark", "src/uvFocusImage/snake.png"),
        ]
        ...
        # UV focus frame - use predefined images
    ...
    def _update_pattern_display(self):
        """Update the read-only pattern display"""
    ...
    def pattern_image(self):
        ...
        return self.event_dispatcher.pattern_image if hasattr(self.event_dispatcher, 'pattern_image') else None
...
# New PatternUploadFrame class to add after line 748 (before ImageSelectFrame)
class PatternUploadFrame:
    def __init__(self, parent, event_dispatcher: EventDispatcher):
        ...
        self.upload_frame = ttk.LabelFrame(self.frame, text="Pattern Upload")
        ...
        self.pattern_selector.frame.grid(row=0, column=0, padx=5, pady=5)
        
        # Pattern info display
        self.info_frame = ttk.LabelFrame(self.frame, text="Pattern Information")
        ...
        self.preview_frame = ttk.LabelFrame(self.frame, text="Pattern Preview")
        self.preview_frame.grid(row=2, column=0, padx=10, pady=10, sticky="ew")
...
class LithographerGui:
    ...
    def __init__(self, config: LithographerConfig):
        ...
        self.multi_image_select_frame = MultiImageSelectFrame(self.middle_panel, self.event_dispatcher, show_pattern_upload=False)
