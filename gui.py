...
class UvFocusFrame: # crosses
    ...
    def _on_uv_focus_change(self, _):
        ...
        if self.uv_focus_selector.thumb.image:
            self.event_dispatcher.set_uv_focus_image(self.uv_focus_selector.thumb.image)
    ...
    def uv_focus_image(self):
        ...
        return self.uv_focus_selector.thumb.image if hasattr(self.uv_focus_selector, 'thumb') else None
...
class RedModeFrame:
    def __init__(self, parent, event_dispatcher: EventDispatcher):
        ...
        self.pattern_display.frame.grid(row=0, column=0, pady=5)
...
class UvModeFrame:
    def __init__(self, parent, event_dispatcher):
        ...
        self.exposure_frame.frame.grid(row=1, column=0, pady=(10,0))
        self.patterning_frame = PatterningFrame(self.frame, event_dispatcher)
        self.patterning_frame.frame.grid(row=2, column=0, pady=(10,0))
...
class LithographerGui:
    ...
    def __init__(self, config: LithographerConfig):
        ...
        self.camera.frame.grid(row=0, column=0, sticky="ew")
        ...
        # Bottom panel (settings and chip management)
